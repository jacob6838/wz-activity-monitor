...
class FieldDevice_FieldDeviceCoreDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldDevice.FieldDeviceCoreDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'datahub.v1'), createEmptyInstance: create)
    ...
    ..a<$core.double>(12, _omitFieldNames ? '' : 'milepost', $pb.PbFieldType.OD)
  ...
  @$pb.TagNumber(1)
  set deviceStatus(FieldDevice_FieldDeviceStatus v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDeviceStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearDeviceStatus() => $_clearField(1);
  ...
  @$pb.TagNumber(2)
  void clearHasAutomaticLocation() => $_clearField(2);

  @$pb.TagNumber(3)
  $2.RoadwayDirection get roadDirection => $_getN(2);
  @$pb.TagNumber(3)
  set roadDirection($2.RoadwayDirection v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRoadDirection() => $_has(2);
  @$pb.TagNumber(3)
  void clearRoadDirection() => $_clearField(3);

  @$pb.TagNumber(4)
  $pb.PbList<$core.String> get roadNames => $_getList(3);
  ...
  @$pb.TagNumber(7)
  $pb.PbList<$core.String> get statusMessages => $_getList(6);
  ...
  @$pb.TagNumber(8)
  void clearIsMoving() => $_clearField(8);

  @$pb.TagNumber(12)
  $core.double get milepost => $_getN(8);
  @$pb.TagNumber(12)
  set milepost($core.double v) { $_setDouble(8, v); }
  @$pb.TagNumber(12)
  $core.bool hasMilepost() => $_has(8);
  @$pb.TagNumber(12)
  void clearMilepost() => $_clearField(12);
  ...
  @$pb.TagNumber(16)
  void clearFirmwareVersion() => $_clearField(16);
  ...
  @$pb.TagNumber(17)
  void clearVelocityKph() => $_clearField(17);
}
...
class FieldDevice_ArrowBoard extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set coreDetails(FieldDevice_FieldDeviceCoreDetails v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCoreDetails() => $_has(0);
  @$pb.TagNumber(1)
  void clearCoreDetails() => $_clearField(1);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set pattern(FieldDevice_ArrowBoard_ArrowBoardPattern v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  void clearIsInTransportPosition() => $_clearField(3);
}
...
class FieldDevice_Camera extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set imageTimestamp($1.Timestamp v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasImageTimestamp() => $_has(2);
  @$pb.TagNumber(3)
  void clearImageTimestamp() => $_clearField(3);
  @$pb.TagNumber(3)
...
class FieldDevice_DynamicMessageSign extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearMessageMultiString() => $_clearField(2);
}
...
class FieldDevice_FlashingBeacon extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set function(FieldDevice_FlashingBeacon_FlashingBeaconFunction v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  void clearIsFlashing() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  void clearSignText() => $_clearField(4);
}
...
class FieldDevice_HybridSign extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set dynamicMessageFunction(FieldDevice_HybridSign_HybridSignDynamicMessageFunction v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDynamicMessageFunction() => $_has(1);
  @$pb.TagNumber(2)
  void clearDynamicMessageFunction() => $_clearField(2);
  ...
  @$pb.TagNumber(3)
  void clearDynamicMessageText() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  void clearStaticSignText() => $_clearField(4);
}
...
class FieldDevice_TrafficSensor_TrafficSensorLaneData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldDevice.TrafficSensor.TrafficSensorLaneData', package: const $pb.PackageName(_omitMessageNames ? '' : 'datahub.v1'), createEmptyInstance: create)
    ...
    ..a<$core.double>(3, _omitFieldNames ? '' : 'averageSpeedKph', $pb.PbFieldType.OD)
    ..a<$core.double>(4, _omitFieldNames ? '' : 'volumeKph', $pb.PbFieldType.OD)
    ..a<$core.double>(5, _omitFieldNames ? '' : 'occupancyPercent', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.double get averageSpeedKph => $_getN(2);
  @$pb.TagNumber(3)
  set averageSpeedKph($core.double v) { $_setDouble(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasAverageSpeedKph() => $_has(2);
  @$pb.TagNumber(3)
  void clearAverageSpeedKph() => $_clearField(3);

  @$pb.TagNumber(4)
  $core.double get volumeKph => $_getN(3);
  @$pb.TagNumber(4)
  set volumeKph($core.double v) { $_setDouble(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasVolumeKph() => $_has(3);
  @$pb.TagNumber(4)
  void clearVolumeKph() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.double get occupancyPercent => $_getN(4);
  @$pb.TagNumber(5)
  set occupancyPercent($core.double v) { $_setDouble(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasOccupancyPercent() => $_has(4);
  @$pb.TagNumber(5)
  void clearOccupancyPercent() => $_clearField(5);
}
...
class FieldDevice_TrafficSensor extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set collectionIntervalStartDate($1.Timestamp v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCollectionIntervalStartDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearCollectionIntervalStartDate() => $_clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set collectionIntervalEndDate($1.Timestamp v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCollectionIntervalEndDate() => $_has(2);
  @$pb.TagNumber(3)
  void clearCollectionIntervalEndDate() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  void clearAverageSpeedKph() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearVolumeKph() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  void clearOccupancyPercent() => $_clearField(6);

  @$pb.TagNumber(7)
  $pb.PbList<FieldDevice_TrafficSensor_TrafficSensorLaneData> get laneData => $_getList(6);
}
...
class FieldDevice_TrafficSignal extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set mode(FieldDevice_TrafficSignal_TrafficSignalMode v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class FieldDevice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldDevice', package: const $pb.PackageName(_omitMessageNames ? '' : 'datahub.v1'), createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(10, _omitFieldNames ? '' : 'workZoneId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..e<$3.MarkedLocationType>(11, _omitFieldNames ? '' : 'locationType', $pb.PbFieldType.OE, defaultOrMaker: $3.MarkedLocationType.MARKED_LOCATION_TYPE_GENERIC, valueOf: $3.MarkedLocationType.valueOf, enumValues: $3.MarkedLocationType.values)
  ...
  @$pb.TagNumber(1)
  set arrowBoard(FieldDevice_ArrowBoard v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasArrowBoard() => $_has(0);
  @$pb.TagNumber(1)
  void clearArrowBoard() => $_clearField(1);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set camera(FieldDevice_Camera v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set dynamicMessageSign(FieldDevice_DynamicMessageSign v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDynamicMessageSign() => $_has(2);
  @$pb.TagNumber(3)
  void clearDynamicMessageSign() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set flashingBeacon(FieldDevice_FlashingBeacon v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasFlashingBeacon() => $_has(3);
  @$pb.TagNumber(4)
  void clearFlashingBeacon() => $_clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set hybridSign(FieldDevice_HybridSign v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasHybridSign() => $_has(4);
  @$pb.TagNumber(5)
  void clearHybridSign() => $_clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set locationMarker(FieldDevice_LocationMarker v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLocationMarker() => $_has(5);
  @$pb.TagNumber(6)
  void clearLocationMarker() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set trafficSensor(FieldDevice_TrafficSensor v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTrafficSensor() => $_has(6);
  @$pb.TagNumber(7)
  void clearTrafficSensor() => $_clearField(7);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set trafficSignal(FieldDevice_TrafficSignal v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasTrafficSignal() => $_has(7);
  @$pb.TagNumber(8)
  void clearTrafficSignal() => $_clearField(8);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  $fixnum.Int64 get workZoneId => $_getI64(9);
  @$pb.TagNumber(10)
  set workZoneId($fixnum.Int64 v) { $_setInt64(9, v); }
  @$pb.TagNumber(10)
  $core.bool hasWorkZoneId() => $_has(9);
  @$pb.TagNumber(10)
  void clearWorkZoneId() => $_clearField(10);

  @$pb.TagNumber(11)
  $3.MarkedLocationType get locationType => $_getN(10);
  @$pb.TagNumber(11)
  set locationType($3.MarkedLocationType v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasLocationType() => $_has(10);
  @$pb.TagNumber(11)
  void clearLocationType() => $_clearField(11);

  @$pb.TagNumber(12)
  $pb.PbList<$3.PointGeometry> get geometry => $_getList(11);

  @$pb.TagNumber(13)
  $pb.PbList<$3.BoundingBox> get bbox => $_getList(12);
}
