...
class Report extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  void clearReportName() => $_clearField(4);
  ...
  @$pb.TagNumber(6)
  void clearWorkersPresent() => $_clearField(6);

  @$pb.TagNumber(7)
  $1.Timestamp get startDate => $_getN(6);
  @$pb.TagNumber(7)
  set startDate($1.Timestamp v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set endDate($1.Timestamp v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set areaType($2.WorkZoneType v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasAreaType() => $_has(8);
  @$pb.TagNumber(9)
  void clearAreaType() => $_clearField(9);
  ...
  @$pb.TagNumber(10)
  void clearMobilitySpeedMph() => $_clearField(10);

  @$pb.TagNumber(11)
  $3.PointGeometry get point => $_getN(10);
  @$pb.TagNumber(11)
  set point($3.PointGeometry v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasPoint() => $_has(10);
  @$pb.TagNumber(11)
  void clearPoint() => $_clearField(11);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set lineString($3.LineStringGeometry v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasLineString() => $_has(11);
  @$pb.TagNumber(12)
  void clearLineString() => $_clearField(12);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set polygon($3.PolygonGeometry v) { $_setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasPolygon() => $_has(12);
  @$pb.TagNumber(13)
  void clearPolygon() => $_clearField(13);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  void clearLicensePlate() => $_clearField(14);

  @$pb.TagNumber(15)
  $3.RoadSurfaceType get surfaceType => $_getN(14);
  @$pb.TagNumber(15)
  set surfaceType($3.RoadSurfaceType v) { $_setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasSurfaceType() => $_has(14);
  @$pb.TagNumber(15)
  void clearSurfaceType() => $_clearField(15);
}
