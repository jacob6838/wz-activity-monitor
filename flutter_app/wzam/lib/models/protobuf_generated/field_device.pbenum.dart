...
class FieldDevice_FieldDeviceStatus extends $pb.ProtobufEnum {
  ...
  const FieldDevice_FieldDeviceStatus._($core.int v, $core.String n) : super(v, n);
}
...
class FieldDevice_ArrowBoard_ArrowBoardPattern extends $pb.ProtobufEnum {
  ...
  const FieldDevice_ArrowBoard_ArrowBoardPattern._($core.int v, $core.String n) : super(v, n);
}
...
class FieldDevice_FlashingBeacon_FlashingBeaconFunction extends $pb.ProtobufEnum {
  ...
  const FieldDevice_FlashingBeacon_FlashingBeaconFunction._($core.int v, $core.String n) : super(v, n);
}
...
class FieldDevice_HybridSign_HybridSignDynamicMessageFunction extends $pb.ProtobufEnum {
  ...
  const FieldDevice_HybridSign_HybridSignDynamicMessageFunction._($core.int v, $core.String n) : super(v, n);
}

/// https://github.com/usdot-jpo-ode/wzdx/blob/develop/spec-content/enumerated-types/MarkedLocationType.md
class FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType extends $pb.ProtobufEnum {
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_AFAD = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(0, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_AFAD');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_DELINEATOR = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(1, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_DELINEATOR');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_FLAGGER = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(2, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_FLAGGER');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_LANE_SHIFT = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(3, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_LANE_SHIFT');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_LANE_CLOSURE = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(4, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_LANE_CLOSURE');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_PERSONAL_DEVICE = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(5, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_PERSONAL_DEVICE');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_RAMP_CLOSURE = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(6, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_RAMP_CLOSURE');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_ROAD_CLOSURE = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(7, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_ROAD_CLOSURE');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_ROAD_EVENT_START = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(8, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_ROAD_EVENT_START');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_ROAD_EVENT_END = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(9, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_ROAD_EVENT_END');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_WORK_TRUCK_WITH_LIGHTS_FLASHING = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(10, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_WORK_TRUCK_WITH_LIGHTS_FLASHING');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_WORK_ZONE_START = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(11, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_WORK_ZONE_START');
  static const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType MARKED_LOCATION_TYPE_WORK_ZONE_END = FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._(12, _omitEnumNames ? '' : 'MARKED_LOCATION_TYPE_WORK_ZONE_END');

  static const $core.List<FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType> values = <FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType> [
    MARKED_LOCATION_TYPE_AFAD,
    MARKED_LOCATION_TYPE_DELINEATOR,
    MARKED_LOCATION_TYPE_FLAGGER,
    MARKED_LOCATION_TYPE_LANE_SHIFT,
    MARKED_LOCATION_TYPE_LANE_CLOSURE,
    MARKED_LOCATION_TYPE_PERSONAL_DEVICE,
    MARKED_LOCATION_TYPE_RAMP_CLOSURE,
    MARKED_LOCATION_TYPE_ROAD_CLOSURE,
    MARKED_LOCATION_TYPE_ROAD_EVENT_START,
    MARKED_LOCATION_TYPE_ROAD_EVENT_END,
    MARKED_LOCATION_TYPE_WORK_TRUCK_WITH_LIGHTS_FLASHING,
    MARKED_LOCATION_TYPE_WORK_ZONE_START,
    MARKED_LOCATION_TYPE_WORK_ZONE_END,
  ];

  static final $core.Map<$core.int, FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType? valueOf($core.int value) => _byValue[value];

  const FieldDevice_LocationMarker_MarkedLocation_MarkedLocationType._($core.int v, $core.String n) : super(v, n);
}
...
class FieldDevice_TrafficSignal_TrafficSignalMode extends $pb.ProtobufEnum {
  ...
  const FieldDevice_TrafficSignal_TrafficSignalMode._($core.int v, $core.String n) : super(v, n);
}
