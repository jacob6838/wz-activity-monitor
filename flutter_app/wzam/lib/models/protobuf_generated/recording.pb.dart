...
class RecordingMarking extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearLaneClosed() => clearField(2);
  ...
  @$pb.TagNumber(3)
  void clearLaneOpened() => clearField(3);
  ...
  @$pb.TagNumber(4)
  void clearWorkersPresent() => clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearSpeedLimitMph() => clearField(5);

  @$pb.TagNumber(6)
  $3.RoadSurfaceType get surfaceType => $_getN(5);
  @$pb.TagNumber(6)
  set surfaceType($3.RoadSurfaceType v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasSurfaceType() => $_has(5);
  @$pb.TagNumber(6)
  void clearSurfaceType() => clearField(6);
}
...
class RecordingPoint extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearNumSatellites() => clearField(2);
  ...
  @$pb.TagNumber(9)
  void clearNumLanes() => clearField(9);

  @$pb.TagNumber(10)
  $core.List<RecordingMarking> get markings => $_getList(9);
}
...
class Recording extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  void clearRecordingName() => clearField(4);
  ...
  @$pb.TagNumber(9)
  void clearMobilitySpeedMph() => clearField(9);

  @$pb.TagNumber(10)
  $3.RoadSurfaceType get surfaceType => $_getN(9);
  @$pb.TagNumber(10)
  set surfaceType($3.RoadSurfaceType v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasSurfaceType() => $_has(9);
  @$pb.TagNumber(10)
  void clearSurfaceType() => clearField(10);

  @$pb.TagNumber(11)
  $core.List<RecordingPoint> get points => $_getList(10);
}
