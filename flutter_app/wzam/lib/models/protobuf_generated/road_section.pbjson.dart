...
const RoadSection$json = {
  ...
  '2': [
    ...
    {'1': 'armed_status', '3': 5, '4': 1, '5': 14, '6': '.datahub.v1.RoadSection.RoadSegmentActiveStatus', '10': 'armedStatus'},
  ...
  '4': [RoadSection_RoadDirection$json, RoadSection_RoadSegmentActiveStatus$json],
  '8': [
    {'1': 'Geometry'},
    {'1': '_end_date'},
...
const RoadSection_RoadDirection$json = {
  '1': 'RoadDirection',
  '2': [
    {'1': 'ROAD_SEGMENT_DIRECTION_BOTH', '2': 0},
    {'1': 'ROAD_SEGMENT_DIRECTION_NORTHBOUND', '2': 1},
    {'1': 'ROAD_SEGMENT_DIRECTION_SOUTHBOUND', '2': 2},
    {'1': 'ROAD_SEGMENT_DIRECTION_EASTBOUND', '2': 3},
    {'1': 'ROAD_SEGMENT_DIRECTION_WESTBOUND', '2': 4},
  ],
};

@$core.Deprecated('Use roadSectionDescriptor instead')
const RoadSection_RoadSegmentActiveStatus$json = {
  '1': 'RoadSegmentActiveStatus',
  '2': [
    {'1': 'ROAD_SEGMENT_ACTIVE_STATUS_ACTIVE', '2': 0},
    {'1': 'ROAD_SEGMENT_ACTIVE_STATUS_INACTIVE', '2': 1},
  ],
};
...
final $typed_data.Uint8List roadSectionDescriptor = $convert.base64Decode(
    ...
    'Rfc3RhdHVzGAUgASgOMi8uZGF0YWh1Yi52MS5Sb2FkU2VjdGlvbi5Sb2FkU2VnbWVudEFjdGl2'
    ...
    'dvbhIrCgRiYm94GBEgAygLMhcuZGF0YWh1Yi52MS5Cb3VuZGluZ0JveFIEYmJveCLKAQoNUm9h'
    'ZERpcmVjdGlvbhIfChtST0FEX1NFR01FTlRfRElSRUNUSU9OX0JPVEgQABIlCiFST0FEX1NFR0'
    '1FTlRfRElSRUNUSU9OX05PUlRIQk9VTkQQARIlCiFST0FEX1NFR01FTlRfRElSRUNUSU9OX1NP'
    'VVRIQk9VTkQQAhIkCiBST0FEX1NFR01FTlRfRElSRUNUSU9OX0VBU1RCT1VORBADEiQKIFJPQU'
    'RfU0VHTUVOVF9ESVJFQ1RJT05fV0VTVEJPVU5EEAQiaQoXUm9hZFNlZ21lbnRBY3RpdmVTdGF0'
    'dXMSJQohUk9BRF9TRUdNRU5UX0FDVElWRV9TVEFUVVNfQUNUSVZFEAASJwojUk9BRF9TRUdNRU'
    '5UX0FDVElWRV9TVEFUVVNfSU5BQ1RJVkUQAUIKCghHZW9tZXRyeUILCglfZW5kX2RhdGVCGQoX'
    'X2JlZ2lubmluZ19jcm9zc19zdHJlZXRCFgoUX2VuZGluZ19jcm9zc19zdHJlZXQ=');
