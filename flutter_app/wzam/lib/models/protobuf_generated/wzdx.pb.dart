...
class Restriction extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set type(RestrictionType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set unit(UnitOfMeasurement v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Lane extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set type(LaneType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set status(LaneStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $core.List<Restriction> get restrictions => $_getList(3);
}
...
class TypeOfWork extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set typeName(WorkTypeName v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  void clearIsArchitecturalChange() => clearField(2);
}
...
class WorkerPresence extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  void clearAreWorkersPresent() => clearField(1);

  @$pb.TagNumber(2)
  WorkerPresenceDefinition get definition => $_getN(1);
  @$pb.TagNumber(2)
  set definition(WorkerPresenceDefinition v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set method(WorkerPresenceMethod v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set workerPresenceLastConfirmedDate($1.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasWorkerPresenceLastConfirmedDate() => $_has(3);
  @$pb.TagNumber(4)
  void clearWorkerPresenceLastConfirmedDate() => clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set confidence(WorkerPresenceConfidence v) { setField(5, v); }
  @$pb.TagNumber(5)
